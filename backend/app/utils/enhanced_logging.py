...
class EnhancedLogger:
    ...
    def setup_logging(self):
        ...
        loguru_config = {
            "handlers": [
                {"sink": sys.stdout, "level": self.log_settings.level.upper(), "format": formatter._fmt},
            ]
        }
        
        if self.log_settings.file:
            loguru_config["handlers"].append(
                {"sink": self.log_settings.file, "level": self.log_settings.level.upper(), "format": formatter._fmt}
            )
