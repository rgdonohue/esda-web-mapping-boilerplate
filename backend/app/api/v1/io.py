...
async def export_geojson(
    ...
    return StreamingResponse(
        ...
        headers={
            "Content-Disposition": f"attachment; filename=spatial_data.geojson"
        }
    )
...
async def export_shapefile(
    ...
    return StreamingResponse(
        ...
        headers={
            "Content-Disposition": f"attachment; filename=spatial_data.shp"
        }
    )
...
async def export_csv(
    ...
    return StreamingResponse(
        ...
        media_type="text/csv",
        headers={
            "Content-Disposition": f"attachment; filename=spatial_data.csv"
        }
    ) 