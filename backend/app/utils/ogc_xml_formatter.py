...
def format_wms_capabilities_xml(capabilities: WMSGetCapabilitiesResponse) -> str:
    ...
    wms.set("xsi:schemaLocation", "http://www.opengis.net/wms http://schemas.opengis.net/wms/1.3.0/capabilities_1_3_0.xsd")
...
def format_wfs_capabilities_xml(capabilities: WFSGetCapabilitiesResponse) -> str:
    ...
    wfs.set("xsi:schemaLocation", "http://www.opengis.net/wfs/2.0 http://schemas.opengis.net/wfs/2.0/wfs.xsd")
    ...
    for feature_type in capabilities.feature_types:
        ...
        default_crs.text = feature_type.get("crs", [])[0] if feature_type.get("crs", []) else "EPSG:4326"
...
def format_ogc_exception_xml(exception_code: str, exception_text: str, locator: Optional[str] = None) -> str:
