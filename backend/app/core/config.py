...
class Settings(BaseSettings):
    ...
    JWT_SECRET_KEY: str = os.getenv(
        "JWT_SECRET_KEY", ENV_SETTINGS.get("jwt_secret_key", "dev-secret-key")
    )
    ...
    GEOMETRY_SIMPLIFICATION_TOLERANCE: float = float(
        os.getenv("GEOMETRY_SIMPLIFICATION_TOLERANCE", "0.0001")
    )
    ...
    def get_logging_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "root": {"level": self.LOG_LEVEL, "handlers": ["console", "file"]},
        }
